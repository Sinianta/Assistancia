...
@section('titre','Assistancia-voir-demandes')
                        ...
                        <div class="stat-widget-two">
                            <div class="media"></div>
                                <div class="media-body">
                                    <h2 class="mt-0 mb-1 text-info">{{$nbA}}</h2><span class="">Demande en attente:</span>
                                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-two">
                            <div class="media">
                                <div class="media-body">
                                    <h2 class="mt-0 mb-1 text-danger">{{$nbR}}</h2><span class="">demandes rejétées</span>
                                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-two">
                            <div class="media">
                                <div class="media-body">
                                    <h2 class="mt-0 mb-1 text-warning">{{$nbT}}</h2><span class="">Demendes Traitées</span>
                                </div>
